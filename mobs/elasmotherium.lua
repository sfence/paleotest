...
minetest.register_entity("hades_paleotest:elasmotherium", {
    -- Stats
    max_hp = 58,
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "hades_paleotest:field_guide" then
            ...
            minetest.show_formspec(clicker:get_player_name(),
                                   "hades_paleotest:elasmotherium_guide",
...
mob_core.register_spawn_egg("hades_paleotest:elasmotherium", "321f15cc", "27140dd9")
